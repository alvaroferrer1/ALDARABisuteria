          ...
          {collections.map((c) => {
            ...
            return (
              <Link
                ...
                className="group overflow-hidden rounded-3xl border border-line transition-transform hover:-translate-y-1.5"
              >
                <div className="flex aspect-4/3 items-center justify-center" style={{ background: `color-mix(in srgb, ${c.color} 14%, var(--surface-2))` }}>
